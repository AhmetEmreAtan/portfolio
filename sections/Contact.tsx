...
const socials = [
  ...
  },
  {
    ...
    label: "LinkedIn",
    value: "ahmetemreatan",
    href: "https://linkedin.com/in/ahmetemreatan",
  ...
  },
  {
    ...
    label: "Twitter",
    value: "@ahmetemreatan",
    href: "https://twitter.com/ahmetemreatan",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <AnimatedSection className="mb-16">
          ...
          <p className="text-lg text-white/50 max-w-2xl leading-relaxed">
            ...
            hear from you — I&apos;m always open to interesting opportunities.
          </p>
        </AnimatedSection>
          ...
          <div className="lg:col-span-2 space-y-8">
            <AnimatedSection delay={0.1}>
              <div className="glass rounded-3xl p-7 border border-white/6 space-y-6">
                <div>
                  <h3 className="font-bold text-white mb-1">Say Hello</h3>
                  <a
                    href="mailto:hello@ahmetemreatan.dev"
                    className="flex items-center gap-2 text-sm text-indigo-400 hover:text-indigo-300 transition-colors"
                  >
                    <FiMail size={14} />
                    hello@ahmetemreatan.dev
                  </a>
                </div>
            ...
            <AnimatedSection delay={0.2}>
              <div className="glass rounded-3xl p-7 border border-white/6">
                <h3 className="font-bold text-white mb-5">Find me online</h3>
              ...
              {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <motion.button
                    ...
                    whileHover={
                      status !== "submitting" ? { scale: 1.02, y: -1 } : {}
                    }
                    whileTap={{ scale: 0.98 }}
                  >
                    {status === "submitting" ? (
